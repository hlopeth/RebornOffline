...
void OpenGLRenderer::init(Window& window)
{
	...
	TextureHandler colorAttachmentTexture;
	...
	TextureHandler outlinedGeomTexture;
	...
	TextureHandler postprocessTexture;
	...
	postprocessPropgram = ShaderProgram(postprocessVertex, postprocessFragment);
...
void OpenGLRenderer::create(ShaderProgram& program)
{
...
void Reborn::OpenGLRenderer::setUniform(const ShaderProgram& program, const GLchar* name, const int& value)
{
	GLuint location = glGetUniformLocation(program.id, name);
	glUniform1i(location, value);
}

void Reborn::OpenGLRenderer::setUniform(const ShaderProgram& program, const GLchar* name, const float& value)
{
	GLuint location = glGetUniformLocation(program.id, name);
	glUniform1f(location, value);
}

void Reborn::OpenGLRenderer::setUniform(const ShaderProgram& program, const GLchar* name, const Vector2& value)
{
	GLuint location = glGetUniformLocation(program.id, name);
	glUniform2f(location, value.x, value.y);
}

void Reborn::OpenGLRenderer::setUniform(const ShaderProgram& program, const GLchar* name, const Vector3& value)
{
	GLuint location = glGetUniformLocation(program.id, name);
	glUniform3f(location, value.x, value.y, value.z);
}

void Reborn::OpenGLRenderer::setUniform(const ShaderProgram& program, const GLchar* name, const Vector4& value)
{
	GLuint location = glGetUniformLocation(program.id, name);
	glUniform4f(location, value.x, value.y, value.z, value.w);
}

void Reborn::OpenGLRenderer::setUniform(const ShaderProgram& program, const GLchar* name, const Matrix2& value, bool transpose)
{
	GLuint location = glGetUniformLocation(program.id, name);
	glUniformMatrix2fv(location, 1, transpose, value._d);
}

void Reborn::OpenGLRenderer::setUniform(const ShaderProgram& program, const GLchar* name, const Matrix3& value, bool transpose)
{
	GLuint location = glGetUniformLocation(program.id, name);
	glUniformMatrix3fv(location, 1, transpose, value._d);
}

void Reborn::OpenGLRenderer::setUniform(const ShaderProgram& program, const GLchar* name, const Matrix4& value, bool transpose)
{
	GLuint location = glGetUniformLocation(program.id, name);
